<details>
  <summary>Какие типы базы данных бывают</summary>
БД бываю разные, в целом это реляционные — в которых данные хранятся в таблицах и могут быть связанны друг с другом, там используются язык запросов SQL и есть 
Не реаляционные — так называемые NOSQL которые тоже бывают разных типов: Ключ- значение, документные графовые, колоночные БД временных рядов
